...
cv2.imwrite("undistorted_rational_test.png", undistorted)
print("已保存: undistorted_rational_test.png")
...
print("已保存: calib_result_rational.npz")
...
yaml_data = {
    "image_width": int(w),
    "image_height": int(h),
    "camera_name": "go2_front_rational",
    "camera_matrix": {
        "rows": 3,
        "cols": 3,
...
with open("camera_intrinsics_rational.yaml", "w") as f:
    yaml.dump(yaml_data, f, sort_keys=False)

print("已保存: camera_intrinsics_rational.yaml")
